...
// @M_Warehouse_ID@
	...
	public org.libero.tables.I_DD_NetworkDistribution getDD_NetworkDistribution() throws RuntimeException
    {
		return (org.libero.tables.I_DD_NetworkDistribution)MTable.get(getCtx(), org.libero.tables.I_DD_NetworkDistribution.Table_Name)
