...
// 0
    ...
    {
		return (I_PP_Order_BOMLine)MTable.get(getCtx(), I_PP_Order_BOMLine.Table_Name)
    ...
    {
		return (org.libero.tables.I_PP_Order_Node)MTable.get(getCtx(), org.libero.tables.I_PP_Order_Node.Table_Name)
	...
	public org.libero.tables.I_PP_Order_Workflow getPP_Order_Workflow() throws RuntimeException
    {
		return (org.libero.tables.I_PP_Order_Workflow)MTable.get(getCtx(), org.libero.tables.I_PP_Order_Workflow.Table_Name)
	...
	public org.libero.tables.I_PP_Cost_Collector getReversal() throws RuntimeException
    {
		return (org.libero.tables.I_PP_Cost_Collector)MTable.get(getCtx(), org.libero.tables.I_PP_Cost_Collector.Table_Name)
