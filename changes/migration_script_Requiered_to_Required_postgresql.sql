...
UPDATE AD_Element SET ColumnName='DurationRequired', Name='Duration Required', PrintName='Duration Required',Updated=TO_TIMESTAMP('2013-09-22 18:19:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53284
;
...
-- IDEMPIERE-1298 2Pack: Support copying of data from one client to another
UPDATE AD_Element SET ColumnName='QtyRequired', Name='Qty Required',Updated=TO_TIMESTAMP('2013-09-22 18:20:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53288
;
...
-- IDEMPIERE-1298 2Pack: Support copying of data from one client to another
UPDATE AD_Element SET ColumnName='SetupTimeRequired', Name='Setup Time Required', PrintName='Setup Time Required',Updated=TO_TIMESTAMP('2013-09-22 18:22:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53291
;
